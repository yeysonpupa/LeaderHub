...
const ExploreCard = ({ id, imgUrl, title, subtitle, index, imagenActividad, linkActividad, active, handleClick }) => (
  <motion.div
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <a href={linkActividad} className="mt-[24px] font-semibold sm:text-[32px] text-[24px] text-white">
          {title}
        </a>
      </div>
    )}
